...
//         $("address").val(address);
//         $("formula").val(callObject.formula);
//     });
...
//             let childrens = parentsCellObject.childrens;
//             let newChildrens = childrens.filter(function() {
...
//             newDb.push(row);
//         }
//         sheetDB.push({db : newDb, visitedCells});
//     }
...
//             currentDB.push(row);
//         }
//         sheetDB.push({db : currentDB, visitedCells});
//         db = currentDB;
...
//             let elem = ops.pop();
//             while (elem != "(") {
//                 values.push(applyOp(elem, value.pop(), values.pop()));
//                 elem = ops.pop();
//             }
//         }
